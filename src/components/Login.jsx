            ...
            <div className="max-w-md mx-auto p-4 border rounded-md shadow-md w-2/3 h-[500px] flex flex-col justify-center bg-white dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="space-y-4 flex flex-col items-center">
                    ...
                    <button
                        ...
                        className="w-[90%] bg-transparent shadow-xl text-black dark:text-gray-300 flex justify-center gap-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                    >
